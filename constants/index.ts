...
export const pricingItem = [
    {
        ...
        title: "Free",
        price: "Free",
        class: "text-[#007AFF] text-[1rem] font-bold leading-6 py-3 px-16 border-[#007AFF] border-[1px] rounded-[3rem]",
        titles: [
            {
                img: lightcheck,
    ...
    },
    {
        ...
        price: "12$ / ",
        month: "mo",
        class: "text-[#fff] text-[1rem] font-bold leading-6 bg-[#007AFF] py-3 px-12 rounded-[3rem]",
        titles: [
            {
                img: lightcheck,
                para: "Unlimited Bandwitch",
...
export const testimonialsItem = [
    {
        ...
        title: "Warsaw, Poland",
        rating: 4.5,
        para: "“Wow... I am very happy to use this VPN, it turned out to be more than my expectations and so far there have been no problems. LokiVPN always the best”.",
    },
    {
        id: 2,
        img: people2,
