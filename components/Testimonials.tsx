		...
		<section
			...
			<div className="w-full flex items-center justify-evenly my-6 gap-5 flex-wrap md:flex-nowrap">
				{testimonialsItem.map((item) => (
					<div
						className="flex flex-col rounded-[0.625rem] border-2 gap-y-6 border-[#007AFF] p-8 w-[500px] h-[250px]"
						key={item.id}>
			...
			<div className="w-full flex items-center justify-between py-4">
				<div className="flex items-center justify-center gap-x-2">
					<div className="w-10 bg-[#007AFF] rounded-lg h-3" />
					<div className="w-4 bg-[#DDE0E4] rounded-full h-3" />
					<div className="w-4 bg-[#DDE0E4] rounded-full h-3" />
					<div className="w-4 bg-[#DDE0E4] rounded-full h-3" />
				</div>
				<div className="flex items-center justify-center gap-x-4">
					<div className="p-2 rounded-full border-2 border-[#007AFF]">
						<Image
							src={arrowback}
							alt="back"
							className="w-[20px]"
					...
					<div className="bg-[#007AFF] p-2 rounded-full border-2 border-[#007AFF]">
						<Image
							src={arrowforward}
							alt="forward"
							className="w-[20px]"
